...
WHERE DD.type IN ('PENDING', 'OFFER', 'PENCIL1', 'PENCIL2', 'PENCIL3', 'PENCIL4', 'PENCIL5', 'OFFER', 'OTHER','NOSTATUS', 'CONFIRMED', 'DEALMEMO')
  AND DD.fee > 0
  AND DD.date BETWEEN CURRENT_DATE AND DATE_ADD(CURRENT_DATE, INTERVAL 6 MONTH)
