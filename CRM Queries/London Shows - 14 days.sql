...
WHERE V.city = "London"
AND DD.type = 'CONTRACT' AND DD.date BETWEEN CURRENT_DATE() AND DATE_ADD(CURRENT_DATE, INTERVAL +14  DAY) AND D.cancelled = 0 AND DD.cancelled = 0 ORDER BY DD.date  ASC