SELECT CONCAT(U.initials, '/', D.id) AS 'Contact Number',
       ...
       NULL                                                   AS 'Notes',
	   NULL                                                   AS 'Statement Drafted',
       NULL                                                   AS 'Notes',
       NULL                                                   AS 'Sent to Assistant',
       NULL                                                   AS 'Approved',
       NULL                                                   AS 'Sent for External Approval',
       NULL                                                   AS 'Paid (enter date)',
       NULL                                                   AS 'Sent Out',
       NULL                                                   AS 'Allocated CRM',
       NULL                                                   AS 'Allocated Sage',
       NULL                                                   AS 'Completed CRM',
       NULL                                                   AS 'Completed Sage',
       NULL                                                   AS 'Uploaded',
       NULL                                                   AS 'Passed over for filing'
